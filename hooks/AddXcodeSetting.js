...
module.exports = function(context) {
    ...
    console.log(2)
    // xcodeProj.addToUserHeaderSearchPaths('../../plugins/com.gss.pdfrenderer/include');
    console.log(3)
    xcodeProj.addToSwiftObjcBridgingHeader('$(PROJECT_DIR)/$(PROJECT_NAME)/Plugins/com.gss.pdfrenderer/PDFRenderer-Bridging-Header.h');
    console.log(4)
